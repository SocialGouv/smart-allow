...
out="$(classify 'ls -la')"
echo "  $out"
[[ "$out" == *'"permissionDecision": "allow"'* ]] && pass "approve via fast-path" || fail "$out"
...
out="$(classify '')"
echo "  $out"
[[ "$out" == *'"permissionDecision": "allow"'* ]] && pass "empty command approved" || fail "$out"
...
echo "  $out"
[[ "$out" == *'"permissionDecision": "ask"'* || "$out" == *'"permissionDecision": "deny"'* ]] && pass "non-approve decision from LLM" || fail "$out"
...
echo "  $out"
[[ "$out" == *'"permissionDecision": "ask"'* || "$out" == *'"permissionDecision": "deny"'* ]] && pass "pipe-to-bash correctly flagged" || fail "$out"
